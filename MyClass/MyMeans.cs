...
namespace 测试工具助手.MyClass
{
    internal class MyMeans
    {
        ...
        public static string AllSql1 = "Select Name FROM SysObjects Where XType='U' orDER BY Name";//获取所有表名
        public static string AllSql2 = "select * from ";// SQL读语句 读取表 的全部数据 （文本格式)
        #endregion
        ...
        /// 测试数据库是否赋加
        /// </summary>
        public void con_open(string M_str_sql)
        {
            M_str_sqlcon = M_str_sql;
            getcon();
            //con_close();
        }
        #endregion
